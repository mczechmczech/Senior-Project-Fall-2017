		...
		btnRegister.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if (firstNameTxtField.getText().equals("") || lastNameTxtField.getText().equals("")
						|| userNameTxtField.getText().equals("") || passwordTxtField.getPassword().length == 0
						|| retypePasswordTxtField.getPassword().length == 0) {
					...
					JOptionPane.showMessageDialog(null,
							"The user name entered is already taken." + "\n" + "Please enter another user name.");
